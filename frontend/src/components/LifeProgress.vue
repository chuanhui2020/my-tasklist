...
const CITY_LIST = [
  { en: 'Beijing', zh: '北京' },
  { en: 'Chaoyang,Beijing', zh: '北京朝阳' },
  { en: 'Haidian,Beijing', zh: '北京海淀' },
  { en: 'Dongcheng,Beijing', zh: '北京东城' },
  { en: 'Xicheng,Beijing', zh: '北京西城' },
  { en: 'Fengtai,Beijing', zh: '北京丰台' },
  { en: 'Tongzhou,Beijing', zh: '北京通州' },
  { en: 'Shanghai', zh: '上海' },
  { en: 'Pudong,Shanghai', zh: '上海浦东' },
  { en: 'Minhang,Shanghai', zh: '上海闵行' },
  { en: 'Xuhui,Shanghai', zh: '上海徐汇' },
  { en: 'Jing\'an,Shanghai', zh: '上海静安' },
  { en: 'Guangzhou', zh: '广州' },
  { en: 'Tianhe,Guangzhou', zh: '广州天河' },
  { en: 'Yuexiu,Guangzhou', zh: '广州越秀' },
  { en: 'Haizhu,Guangzhou', zh: '广州海珠' },
  { en: 'Panyu,Guangzhou', zh: '广州番禺' },
  { en: 'Shenzhen', zh: '深圳' },
  { en: 'Nanshan,Shenzhen', zh: '深圳南山' },
  { en: 'Futian,Shenzhen', zh: '深圳福田' },
  { en: 'Luohu,Shenzhen', zh: '深圳罗湖' },
  { en: 'Baoan,Shenzhen', zh: '深圳宝安' },
  { en: 'Longhua,Shenzhen', zh: '深圳龙华' },
  { en: 'Longgang,Shenzhen', zh: '深圳龙岗' },
  { en: 'Hangzhou', zh: '杭州' },
  { en: 'Xihu,Hangzhou', zh: '杭州西湖' },
  { en: 'Binjiang,Hangzhou', zh: '杭州滨江' },
  { en: 'Yuhang,Hangzhou', zh: '杭州余杭' },
  { en: 'Chengdu', zh: '成都' },
  { en: 'Wuhou,Chengdu', zh: '成都武侯' },
  { en: 'Jinjiang,Chengdu', zh: '成都锦江' },
